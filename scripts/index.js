...
// CLONING NODES FOR THE ANIMATION
let nodeSelect = document.querySelector('.logos-slide');

let nodeCopyArray = [];

for (let i = 0; i < 3; i++) {
  nodeCopyArray.push(nodeSelect.cloneNode(true));
}

let parentNode = document.querySelector('.logos');

nodeCopyArray.forEach((nodeCopy) => {
